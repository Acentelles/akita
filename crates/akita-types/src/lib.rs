...
pub use proof::{
    ...
    segment_typed_z_payload_bytes, select_setup_prefix_slot, setup_offload_ring_dim_supported,
    setup_prefix_precommitted_params, setup_prefix_slot_id, tail_golomb_rice_z_params,
    ...
    MAX_SETUP_MATRIX_FIELD_ELEMENTS, MULTI_GROUP_ROOT_MULTI_CHUNK_UNSUPPORTED,
    SETUP_OFFLOAD_D_SETUP, SETUP_OFFLOAD_MIN_PREFIX_FIELD_LEN, SETUP_OFFLOAD_SUPPORTED_RING_DIMS,
...
pub use schedule::{
    ...
    DirectStep, ExecutionSchedule, FoldStep, GroupBoundPolicy, PrecommittedGroupParams, Schedule,
    Step,
};
...
pub use stage3_geometry::{
    bind_setup_product_claim_and_sample_eta, suffix_aligned_group_packed_point,
    BatchedStage3Geometry,
};
