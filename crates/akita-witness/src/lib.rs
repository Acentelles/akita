...
//!   plus its `num_vars` shape). It is the thing the prover's sumcheck Tier-A
//!   kernel reads while walking a declared expression, and the thing the polyops
//!   standard views hand out.
